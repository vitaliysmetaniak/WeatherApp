...
import com.example.weatherapp.data.repository.model.HourRepoModel
...
fun HourDomainModel.toRepoModel(): HourRepoModel {
...
fun HourRepoModel.toDomainModel(): HourDomainModel {
